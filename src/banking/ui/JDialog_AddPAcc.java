...
public class JDialog_AddPAcc extends javax.swing.JDialog {
	...
	private DefaultGUI parentframe;
	private BankFactory bankFactory;
	private Controller controller;

	public JDialog_AddPAcc(DefaultGUI parent, Controller controller) {
		super(parent);
		parentframe = parent;
		this.bankFactory = new PersonFactory();
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
		...
		if (!name.isEmpty() && !street.isEmpty() && !city.isEmpty() && !state.isEmpty() && !zip.isEmpty()
			...
			try {
				CustomerDefault customer = bankFactory.createCustomer(name, street, city, state, Integer.parseInt(zip),
						email, accountNumber);
				controller.addCustomer(customer);
				JOptionPane.showMessageDialog(parentframe, "Account Created");
				dispose();
			} catch (NumberFormatException e) {
				JOptionPane.showMessageDialog(parentframe, "Invalid Number format");
			}
		} else {
