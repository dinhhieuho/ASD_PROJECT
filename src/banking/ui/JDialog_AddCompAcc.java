...
public class JDialog_AddCompAcc extends javax.swing.JDialog
{
	...
	public JDialog_AddCompAcc(BankGUI parent,BankFactory bankFactory,Controller controller)
	{
		super(parent);
		parentframe=parent;
		this.bankFactory = new CompanyFactory();
		...
		JButton_OK.setActionCommand("companyaccount");
	...
	{ 
	   String name = JTextField_NAME.getText();
		...
		String numEmps = JTextField_NoOfEmp.getText();
		...
		if(!name.isEmpty() && !street.isEmpty() &&
				...
				&& !email.isEmpty() && !accountNumber.isEmpty() && !numEmps.isEmpty()) {

			try {
			CustomerDefault customer = bankFactory.createCustomer(name,street,city,state,Integer.parseInt(zip),email,accountNumber,acctype,Integer.parseInt(numEmps));
			controller.addCustomer(customer);
			JOptionPane.showMessageDialog(parentframe, "Account Created");
				dispose();
			}catch(NumberFormatException e) {
				JOptionPane.showMessageDialog(parentframe, "Invalid Input format");
			}
