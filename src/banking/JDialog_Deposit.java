...
public class JDialog_Deposit extends javax.swing.JDialog {
	...
	public JDialog_Deposit(FincoDefaultView parent, ControllerContext context, String accnr) {
		super(parent);
		parentframe = parent;
		...
		JTextField_ACCNR.setBounds(84, 12, 144, 24);
		JButton_OK.setText("OK");
		JButton_OK.setActionCommand("deposit");
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
		String amountDeposit = JTextField_Deposit.getText();
