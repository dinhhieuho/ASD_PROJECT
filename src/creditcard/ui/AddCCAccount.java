...
public class AddCCAccount extends javax.swing.JDialog {
	...
	private CcardGUI parentframe;
	private CcardFactory factory;
	private Controller controller;

	public AddCCAccount(CcardGUI parent,CcardFactory factory,Controller controller) {
		super(parent);
		parentframe = parent;
		factory = factory;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
		...
		parentframe.email = JLabel7.getText();
		...
		if(JTextField_NAME.getText().isEmpty() || JTextField_STR.getText().isEmpty() 
				|| JTextField_CT.getText().isEmpty() || JTextField_ZIP.getText().isEmpty() ||
				JTextField_ST.getText().isEmpty() || JTextField_CCNR.getText().isEmpty() ||
				JTextField_ExpDate.getText().isEmpty()) {
